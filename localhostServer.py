...
class Server:
    ...
    def offer(self, network_type, tcp_sock):
        ...
        # broadcast_ip = str(ipaddress.ip_network('127.0.0.1' + '/24', False).broadcast_address)
        nice_print("Broadcasting on localost")
    ...
    def log_statistics(self):
        ...
        try:
            ...
            for player in self.players_sockets:
                ...
                high_score = max(len(str(player.get_typed())), high_score)
    ...
    def print_statistics(self):
        try:
            ...
            nice_print(f"Highest score ever: {high_score}")
